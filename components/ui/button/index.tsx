...
const buttonStyle = tva({
  base: "group/button bg-primary-500 data-[focus-visible=true]:web:outline-none data-[focus-visible=true]:web:ring-2 flex-row items-center justify-center rounded data-[disabled=true]:opacity-40",
  variants: {
    action: {
      primary:
